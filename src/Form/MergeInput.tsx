	...
	render() {
		...
		return (
		  <>
				...
				<div className={"poemui-controls__merge" + wrapperClassDisabled + wrapperClassIcon+ wrapperClassUi}>
			      {icon || null}
				  <input 
					  type={typeRes} 
			          id={idRes}
                      ...
                      {...attributes}
					/>
			        <button type={btnType || 'button'} className="poemui-btn poemui-btn__bg--primary"><span>{label || null}</span></button>
