	...
	render() {
		...
		return (
		  <>
				...
				<div className={"poemui-controls poemui-controls__number" + wrapperClassDisabled + wrapperClassTheme }>
			        {theme === 'line' ? <><ins className="poemui-controls__bar"></ins><ins className="poemui-controls__basic-bar"></ins></> : ''}
					  <input 
						  ...
						  {...attributes}
						/>
					  <span className="poemui-controls__number__btn poemui-controls__number__btn--add" data-min={min || null} data-max={max || null} data-step={btnStepPlus || 1} onClick={this.handlePlus}>+</span>
					  <span className="poemui-controls__number__btn poemui-controls__number__btn--remove" data-min={min || null} data-max={max || null} data-step={btnStepMinus || 1} onClick={this.handleMinus}>-</span>	
