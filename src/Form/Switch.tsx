	...
	render() {
		...
		return (
		  <>
				...
				<div className={"poemui-controls poemui-controls__toggle" + wrapperClassDisabled + wrapperClassUi + wrapperClassActive } data-targetid={targetID || ''} aria-checked={(checkedStatus ? 'true' : 'false')}>
					<label htmlFor={idRes}>
					   ...
					   {checkedStatus ? (
	                    ...
	                    <span className="poemui-controls__toggle-trigger" data-off-text={textOff || 'off'} data-on-text={textOn || 'on'}></span>
					    {label || null}
