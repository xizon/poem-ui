	...
	render() {
		...
		return (
		  <>
			...
			<div ref={this.rootRef} className={"poemui-controls__tags-wrapper" + wrapperClassUi}>
				<div>
					<ul className="poemui-controls__tags__list">
						{this.createAddedList()}
					</ul>

					<div className={"poemui-controls__tags" + wrapperClassDisabled}>
						<input
							type="text"
							autoComplete="off"
