...
export function hybridSliderAnime( curElement: any, config: hybridSliderAnimeConfig ) {
    ...
    config = __.setDefaultOptions({
        ...
        "timing"            : 10000,
        "loop"              : false,
        "paginationID"      : ".poemui-hybridslider__pagination",
        "arrowsID"          : ".poemui-hybridslider__arrows",
        "draggable"         : false,
    ...
    let dataSpeed              = config.speed,
        ...
        dataNext               = `${dataControlsArrows} .poemui-hybrid-content-slider__controls--next`,
        dataPrev               = `${dataControlsArrows} .poemui-hybrid-content-slider__controls--prev`;
    ...
    let $itemsOuter     = $sliderWrapper.find( '.poemui-hybrid-content-slider__items' ),
        $items          = $sliderWrapper.find( '.poemui-hybrid-content-slider__items .poemui-hybrid-content-slider__item' ),
    ...
    function sliderInit() {
        ...
        //
        const $dragTrigger = $sliderWrapper.find( '.poemui-hybrid-content-slider__items' );
        let mouseX, mouseY;
        ...
        function dragStart(e) {
            ...
            if ( targetIndex === null ) targetIndex = __( e.target ).closest( '.poemui-hybrid-content-slider__item' ).data( 'index' );
            if ( targetIndex === null ) targetIndex = __( e.target ).find( '.poemui-hybrid-content-slider__item' ).data( 'index' );
    ...
    */
    function itemUpdates( wrapper, curBtn, delta, speed, dragging, indexGo, itemsHeight ) {
        ...
        let $curWrapper = wrapper.children( '.poemui-hybrid-content-slider__items' ),  //Default: $itemsOuter
            $curItems   = $curWrapper.find( '.poemui-hybrid-content-slider__item' ); //Default: $items
