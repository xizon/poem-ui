...
export default class MenuList extends Component<MenuListProps, MenuListState>  {
    ...
    handleMouseEnter(e) {
        ...
        ////////////////////////////////////////////////////////////
        */
        const menuContainer = e.currentTarget.closest( '.poemui-menu__container' );
        if ( menuContainer !== null && menuContainer.classList.contains( 'is-mobile' ) ) return;


        //
        const self = this;
        TweenMax.set( [e.currentTarget.querySelector( 'ul.sub-menu' ), e.currentTarget.querySelector( '.poemui-menu__arrow-mega' )], {
            css: {
                opacity    : 0,
                display    : 'block',
    ...
    handleMouseLeave(e) {
        ...
        */
        ...
        //
        const self = this;
        TweenMax.to( [e.currentTarget.querySelector( 'ul.sub-menu' ), e.currentTarget.querySelector( '.poemui-menu__arrow-mega' )], 0.3, {
            css: {
                opacity    : 0,
                marginTop  : self.animMarginTop + 'px'
            },
    ...
    componentDidMount() {
        ...
        */
        ...
        const megaMenuRootLi = document.querySelectorAll( '.poemui-menu__container:not(.is-mobile) li.multi-column' );
	...
	render() {
            ...
            if ( typeof(item.title) === 'string' ) {
                ...
                return (
                    ...
                    >
                        ...
                        {/* Desktop arrow */}
                        {item.mega && !mobile ? <span className="poemui-menu__arrow-mega"></span> : ''}
                        {(item.children || item.mega) && !mobile ? <span className="poemui-menu__arrow"></span> : ''}

                        {/* Mobile arrow */}
                        {mobile && (item.mega || item.children) ? <em className="poemui-menu__arrow-mobile"></em> : ''}
        ...
        return <ul className="poemui-menu">{options}</ul>;
...
render() {
    ...
    return (
      ...
      <nav className="poemui-menu__container">
        <div className="poemui-menu__inner">
            <span className="poemui-brand--mobile"><img src="" /></span>
            <ul className="poemui-menu">
                    ...
                    <ul className="sub-menu">
                        ...
                        <li>
                            ...
                            <ul className="sub-menu multi">
                                ...
                                <li><a href="#">Menu Text</a></li>
                                <li><a href="#">Menu Text</a></li>
                                <li><a href="#">Menu Text</a><span className="poemui-bubble">new</span></li>
                            </ul>
                        </li>
