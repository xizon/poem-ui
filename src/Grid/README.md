...
[Source](https://github.com/xizon/poem-ui/tree/main/src/Grid)
...
### GridColumn
```js
import { GridColumn } from 'poem-ui/Grid';
```
| Property | Type | Default | Description |
| --- | --- | --- | --- |
...
export default () => {
  return (
    <>
        ...
        <h3>No Gutter Column For Grid</h3>
        <p>
        ...
        <div className="poemui-clearfix"></div>
        

        <div className="poemui-t-c">
