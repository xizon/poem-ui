...
import '@/components/DropdownMenu/styles/_style.scss';
import '@/components/DropdownMenu/styles/rtl/_style.scss';
...
export default class DropdownMenu extends Component<DropdownMenuProps, DropdownMenuState> {
	...
	handleClose(e) {
        ...
        if ( e.target.closest( '.poemui-dropdown-menu' ) === null ) {
            this.setState({
                opened: false
            });
        }
    ...
    render() {
        ...
        return (
            <>
                ...
                <div className={"poemui-dropdown-menu" + (this.state.opened ? ' is-opened' : '')} id={cid} onClick={this.handleClick}>
                    <span>
                        {btnIcon || null}
