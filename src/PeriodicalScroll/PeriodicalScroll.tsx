...
import '@/components/PeriodicalScroll/styles/_style.scss';

/*-- Apply Third-party animation plugins --*/
import TweenMax, { TimelineMax } from '@/components/_plugins/_lib-gsap';

//
import PeriodicalScrollItem from '@/components/PeriodicalScroll/PeriodicalScrollItem';
     ...
     render() {
        ...
        return (
            <>
                ...
                ref={this.rootRef}
                id={id || this.uniqueID}
                className="poemui-periodical-scroll">
