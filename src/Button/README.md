...
[Source](https://github.com/xizon/poem-ui/tree/main/src/Button)
...
### Button
```js
import { Button } from 'poem-ui/Button';
```
...
### ButtonGroup
```js
import { ButtonGroup } from 'poem-ui/Button';
```
| Property | Type | Default | Description |
| --- | --- | --- | --- |
...
export default () => {
  return (
    <>
		...
		<Button border="thin" spacing="bottom" background="primary" size="tiny" href="#" ><i className="icon-bullhorn" aria-hidden="true"></i>Tiny</Button>
		<Button border="thin" spacing="bottom" background="primary" size="small" href="#"><i className="icon-bullhorn" aria-hidden="true"></i>Small</Button>
		<Button border="thin" spacing="bottom" background="primary" size="medium" href="#"><i className="icon-cogs" aria-hidden="true"></i>Medium</Button>
		<Button border="thin" spacing="bottom" background="primary" size="large" href="#"><i className="icon-flask" aria-hidden="true"></i>Large</Button>

		{/*    /////////////////////////   */} 

		<Button border="thin" spacing="bottom" background="primary" size="tiny" href="#">Tiny<i className="icon-bullhorn" aria-hidden="true"></i></Button>
		<Button border="thin" spacing="bottom" background="primary" size="small" href="#">Small<i className="icon-bullhorn" aria-hidden="true"></i></Button>
		<Button border="thin" spacing="bottom" background="primary" size="medium" href="#">Medium<i className="icon-cogs" aria-hidden="true"></i></Button>
		<Button border="thin" spacing="bottom" background="primary" size="large" href="#">Large<i className="icon-flask" aria-hidden="true"></i></Button>

		{/*    /////////////////////////   */} 

		<Button border="thin" spacing="bottom" background="primary" size="small" icon={<><i className="icon-bullhorn" aria-hidden="true"></i></>} iconPosition="right" href="#">Icon Right</Button>
		<Button border="thin" spacing="bottom" background="primary" size="small" icon={<><i className="icon-cogs" aria-hidden="true"></i></>} iconPosition="left" href="#">Icon Left</Button>
		<Button border="thin" spacing="bottom" background="primary transparent" corners="pill" size="small" icon={<><i className="icon-bullhorn" aria-hidden="true"></i></>} iconPosition="left" href="#">Icon Left</Button>
		<Button border="thin" spacing="bottom" background="primary transparent" corners="pill" size="small" icon={<><i className="icon-cogs" aria-hidden="true"></i></>} iconPosition="right" href="#">Icon Right</Button>
		...
		<div className="poemui-t-c" style={{background:"#333",padding:"1.5rem 0 0",marginTop:"1rem"}}>
			...
			<Button border="thin" spacing="bottom" background="secondary fillwhite" size="small" icon={<><i className="icon-bullhorn" aria-hidden="true"></i></>} iconPosition="right" href="#">Icon Right</Button>
			<Button border="thin" spacing="bottom" background="secondary fillwhite" size="small" icon={<><i className="icon-cogs" aria-hidden="true"></i></>} iconPosition="left" href="#">Icon Left</Button>

			{/*    /////////////////////////   */} 

			<Button border="thin" spacing="bottom" background="secondary" size="small" icon={<><i className="icon-bullhorn" aria-hidden="true"></i></>} iconPosition="right" href="#">Icon Right</Button>
			<Button border="thin" spacing="bottom" background="secondary" size="small" icon={<><i className="icon-cogs" aria-hidden="true"></i></>} iconPosition="left" href="#">Icon Left</Button>
