...
export default class Pagination extends Component<PaginationProps, PaginationState> {
    ...
    render() {
        ...
        switch (align) {
            case 'left':
                alignClassName = ' poemui-t-l';
                break;
            case 'right':
                alignClassName = ' poemui-t-r';
                break;
            case 'center':
                alignClassName = ' poemui-t-c';
                break;
        }
        ...
        return (
            <>
                <nav aria-label="Page navigation" className={"poemui-pagination__container" + alignClassName}>
                    <ul>
                        {firstLabel ? (
