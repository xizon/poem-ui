...
export default class Parallax extends Component<ParallaxProps, ParallaxState> {
    ...
    parallaxInit(w) {
        ...
        // Pure parallax scrolling effect without other embedded HTML elements
        //------------------------------------------
        if (reactDomEl.classList.contains('poemui-parallax--el')) {
        ...
        //------------------------------------------
        if (!reactDomEl.classList.contains('poemui-parallax--el')) {
            const $curImg = reactDomEl.querySelector('.poemui-parallax__img'),
                dataImg = $curImg.src;
            ...
            img.onload = function () {
                ...
                if (
                    reactDomEl.classList.contains('poemui-height--10') ||
                    reactDomEl.classList.contains('poemui-height--20') ||
                    reactDomEl.classList.contains('poemui-height--30') ||
                    reactDomEl.classList.contains('poemui-height--40') ||
                    reactDomEl.classList.contains('poemui-height--50') ||
                    reactDomEl.classList.contains('poemui-height--60') ||
                    reactDomEl.classList.contains('poemui-height--70') ||
                    reactDomEl.classList.contains('poemui-height--80') ||
                    reactDomEl.classList.contains('poemui-height--90') ||
                    reactDomEl.classList.contains('poemui-height--100')
                ) {
                ...
                //If the ".poemui-v-align--absolute" has more content
                if (w <= 768) {

                    if (reactDomEl.querySelector('.poemui-v-align--absolute').offsetHeight >= curImgH) {
                        reactDomEl.querySelector('.poemui-v-align--absolute').classList.add( 'poemui-v-align--relative' );
            ...
            <>
                ...
                {!_parallaxElements ? (
                    ...
                    <div
                        ref={this.rootRef}
                        id={id || this.uniqueID}
                        className={`poemui-parallax--el ${heightClass || ''}`}
