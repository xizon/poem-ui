...
import '@/components/SeamlessScrollingElement/styles/_style.scss';

/*-- Apply Third-party animation plugins --*/
import TweenMax, { TimelineMax } from '@/components/_plugins/_lib-gsap';

//
import SeamlessScrollingElementItem from '@/components/SeamlessScrollingElement/SeamlessScrollingElementItem';
        ...
        return (
            <>
                ...
                <div
                    ref={this.rootRef}
                    id={id || this.uniqueID}
                    className="poemui-seamless-scrolling"
