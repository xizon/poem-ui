	...
	render() {
		...
		return (
		  <>
				...
				<li onClick={switchEv} role="presentation" className={activedClassName} data-tab={targetID}>{index === 1 ? <><div className="poemui-tabs__marker"></div></> : ''}<a href="#" {...attributes}>{children}</a></li>
