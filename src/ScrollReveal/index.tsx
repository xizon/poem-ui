...
import '@/components/ScrollReveal/styles/_style.scss';

/*-- Apply Third-party animation plugins --*/
import TweenMax, { TimelineMax } from '@/components/_plugins/_lib-gsap';
...
export default class ScrollReveal extends Component<ScrollRevealProps, ScrollRevealState> {
	...
	getAnimConfiguration() {
		...
		let config = reactDomEl.dataset.poemuiAnim;
	...
	* #Usage: 
	...
	<ul data-poemui-anim='{"viewport":"90%","from":{"y":0},"to":{"y":0},"ease":"Power2.easeOut","duration":0.8,"delay":0.2,"infinite":true}' data-img-ids='["[data-imgshow]"]'>
	...
	render() {
		...
		return (
		  <>
			...
			ref={this.rootRef} 
			id={id || this.uniqueID}
			data-poemui-anim={config || '{"viewport":"80%","from":{"opacity":0,"y":150},"to":{"opacity":1,"y":0},"ease":"Power2.easeOut","duration":0.8,"delay":0,"infinite":true}'}
			{...attributes}>
			    {children}
			</div>
